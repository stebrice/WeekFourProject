...
public class FollowersTimelineFragment extends RelatedUsersFragment {
    ...
    public static FollowersTimelineFragment newInstance(User user) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            ((FollowersFollowingsActivity) getActivity()).setActionBarTitle("Followers");
    ...
    private void populateTimeline(){
        client.getFollowersTimeline(new JsonHttpResponseHandler(){
            @Override
    ...
    private void populateTimelineFromCursor(long maxToUse){
        client.getFollowersTimelineFromCursor(new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                friendFollowerModel = FriendFollowerModel.fromJSON(response);
                ArrayList<User> newItems = friendFollowerModel.getUsers();
