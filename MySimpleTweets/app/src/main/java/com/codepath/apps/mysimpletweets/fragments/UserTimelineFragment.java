...
public class UserTimelineFragment extends TweetsListFragment implements ComposeFragment.ComposeDialogListener {
    ...
    public static UserTimelineFragment newInstance(User user) {
        ...
        args.putParcelable("user_to_use", Parcels.wrap(user));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            user = (User) Parcels.unwrap(getArguments().getParcelable("user_to_use"));
            populateTimeline();
        }
        catch (Exception e){
            Toast.makeText(getContext(), e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void populateTimelineFromMaxID(long maxToUse){
        client.getUserTimelineFromMaxID(new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                ArrayList<Tweet> newItems = Tweet.fromJSONArray(response);
                addPulledData(newItems, false);
        ...
        },user.getUid(), maxToUse);
    }

    private void populateTimelineFromSinceID(long sinceToUse){
        client.getUserTimelineFromSinceID(new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                ArrayList<Tweet> newItems = Tweet.fromJSONArray(response);
...
//        startActivityForResult(i, REQUEST_CODE);
        ...
        composeFragment.setTargetFragment(UserTimelineFragment.this, REQUEST_CODE);
